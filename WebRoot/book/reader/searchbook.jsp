...
<br>
<table>
	<form action="querybookbynameisbnpublishauthor" method="post">
	<tr>
		<td> <div align=left style="width: 200; height: 30">
		...
		<td><DIV align=left style="width:200; height:30">
			<b> <font color="#ff9900" size="2">出版社：</font> </b>
			<b><input name="b.bookpublish" /></b>
			<br>
		</DIV></td>
		<td><DIV align=left style="width: 200; height:30">
			<b> <font color="#ff9900" size="2">作者：</font> </b>
			<b><input name="b.bookauthor" /></b>
			<br>
		</DIV><td>
...
<br/>
<br/>
	<table align="left" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="80%" id="AutoNumber1" bgcolor="#FFCC66">
	  <tr>
			...
			<td width="84%" bgcolor="#FFFFFF">
				...
				<DIV align=left style="width: 563; height: 81">
					...
					<table class="txt" cellSpacing="1" cellPadding="1" width="90%"
						align="left" bgColor="#005b4b" border="0">
						<tr bgColor="#bad4a5">
